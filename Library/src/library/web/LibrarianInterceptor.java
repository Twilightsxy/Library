...
public class LibrarianInterceptor implements HandlerInterceptor {

	private final static Log log = LogFactory.getLog(LibrarianInterceptor.class);
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object arg2) throws Exception {
		...
		response.sendRedirect(url + "/login/librarian");
		return false;
	}
