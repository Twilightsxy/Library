...
public class LibrarianForm {
	 ...
	 * @param deleteS   删除标记
	 */
	public LibrarianForm(String lUserName, String lPassword, String lName, String lSex, String lEmail, String lTel) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (lUserName == null) {
			if (other.getlUserName() != null)
				return false;
		} else if (!lUserName.equals(other.getlUserName()))
			return false;
		return true;
	}
